    ...
    public partial class init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    UserId = table.Column<string>(type: "text", nullable: false),
                    CitizenIDNumber = table.Column<string>(type: "text", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LessorName = table.Column<string>(type: "text", nullable: true),
                    LessorCardIssuanceDate = table.Column<DateOnly>(type: "date", nullable: false),
                    LessorCardAddress = table.Column<string>(type: "text", nullable: true),
                    LesseeNumberCard = table.Column<string>(type: "text", nullable: true),
                    LesseeName = table.Column<string>(type: "text", nullable: true),
                    LesseeCardIssuanceDate = table.Column<DateOnly>(type: "date", nullable: false),
                    LesseeCardAddress = table.Column<string>(type: "text", nullable: true),
                    Description = table.Column<string>(type: "text", nullable: true),
                    ...
                    Price = table.Column<decimal>(type: "numeric", nullable: false),
                    ContractSnapshot = table.Column<string>(type: "text", nullable: true),
                    Status = table.Column<int>(type: "integer", nullable: false),
                    Name = table.Column<string>(type: "text", nullable: true),
                    CreatedBy = table.Column<string>(type: "text", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "timestamp without time zone", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    ContractId = table.Column<long>(type: "bigint", nullable: false),
                    IsLessorAgreed = table.Column<bool>(type: "boolean", nullable: false, defaultValue: false),
                    LessorSignedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    LessorIpAddress = table.Column<string>(type: "character varying(45)", maxLength: 45, nullable: true),
                    LessorSignatureData = table.Column<string>(type: "character varying(250)", maxLength: 250, nullable: true),
                    IsLesseeAgreed = table.Column<bool>(type: "boolean", nullable: false, defaultValue: false),
                    LesseeSignedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    LesseeIpAddress = table.Column<string>(type: "character varying(45)", maxLength: 45, nullable: true),
                    LesseeSignatureData = table.Column<string>(type: "character varying(250)", maxLength: 250, nullable: true),
                    VerificationStatus = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ContractVerifications", x => x.ContractId);
                    table.ForeignKey(
