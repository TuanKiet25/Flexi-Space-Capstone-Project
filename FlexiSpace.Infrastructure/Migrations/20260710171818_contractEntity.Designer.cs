...
namespace FlexiSpace.Infrastructure.Migrations
{
    ...
    [Migration("20260710171818_contractEntity")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FlexiSpace.Domain.Entities.ContractVerification", b =>
                {
                    ...
                    b.Property<string>("RawQRData")
                        .HasColumnType("text");

                    b.Property<string>("ScannedName")
                        .HasColumnType("text");
                    ...
                    b.ToTable("ContractVerification");
                });
            ...
            modelBuilder.Entity("FlexiSpace.Domain.Entities.ContractVerification", b =>
                {
                    b.HasOne("FlexiSpace.Domain.Entities.Contract", "Contract")
                        .WithMany("ContractVerifications")
            ...
            modelBuilder.Entity("FlexiSpace.Domain.Entities.Contract", b =>
                {
                    b.Navigation("ContractVerifications");
                });
