...
namespace FlexiSpace.Application.Tests
{
    public class AuthServiceTests
    {
        ...
        {
            // 1. ARRANGE
            var request = new RegisterRequest("existing@email.com", "Password123!", "0123456789", "username", "User Name", "valid-token");
            _mockTurnstileService
                .Setup(s => s.VerifyTokenAsync(request.TurnstileToken))
                .ReturnsAsync(true);
            _mockUserRepository
        ...
        {
            // 1. ARRANGE
            var request = new RegisterRequest("newuser@email.com", "Password123!", "0123456789", "username", "User Name", "valid-token");
            _mockTurnstileService
                .Setup(s => s.VerifyTokenAsync(request.TurnstileToken))
                .ReturnsAsync(true);
            _mockUserRepository!
